...
#Make check that correct number of arguments are given when starting the script.
    ...
    while test -n "$well_letters"; do
        ...
        do
            ...
            do
                ...
                then
                	matlab -nodisplay -nodesktop -nosplash -r "cd $dir/features; [arr exit_status] = process_63x('$dir/tmp/siIn','$dir/tmp/siOut',$1); exit(exit_status);"
                else
